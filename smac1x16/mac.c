...
AES_BLOCK_XOR(const aes_block_t a, const aes_block_t b)
{
    return (aes_block_t) {
        ...
        _mm_xor_si128(a.bc, b.bc), _mm_xor_si128(a.bd, b.bd), _mm_xor_si128(a.be, b.be),
        _mm_xor_si128(a.bf, b.bf),
    };
}
...
AES_BLOCK_LOAD(const uint8_t *a)
{
    return (aes_block_t) {
        ...
        _mm_loadu_si128((const __m128i *) (const void *) (a + 192)),
        _mm_loadu_si128((const __m128i *) (const void *) (a + 208)),
        _mm_loadu_si128((const __m128i *) (const void *) (a + 224)),
        _mm_loadu_si128((const __m128i *) (const void *) (a + 240)),
    };
}
...
AES_BLOCK_LOAD_BROADCAST(const uint8_t *a)
{
    ...
    return (aes_block_t) { x, x, x, x, x, x, x, x, x, x, x, x, x, x, x, x };
}
...
AES_BLOCK_LOAD_64x2(uint64_t a, uint64_t b)
{
    ...
    return (aes_block_t) { t, t, t, t, t, t, t, t, t, t, t, t, t, t, t, t };
}
...
AES_BLOCK_STORE(uint8_t *a, const aes_block_t b)
{
    ...
    _mm_storeu_si128((__m128i *) (void *) (a + 192), b.bc);
    _mm_storeu_si128((__m128i *) (void *) (a + 208), b.bd);
    _mm_storeu_si128((__m128i *) (void *) (a + 224), b.be);
    _mm_storeu_si128((__m128i *) (void *) (a + 240), b.bf);
}
...
AES_ENC(const aes_block_t a, const aes_block_t b)
{
    return (aes_block_t) {
        ...
        _mm_aesenc_si128(a.bc, b.bc), _mm_aesenc_si128(a.bd, b.bd), _mm_aesenc_si128(a.be, b.be),
        _mm_aesenc_si128(a.bf, b.bf),
    };
}
...
#define PERMUTE(a)                                                                                \
    ...
    {                                                                                             \
        P(a.b0), P(a.b1), P(a.b2), P(a.b3), P(a.b4), P(a.b5), P(a.b6), P(a.b7), P(a.b8), P(a.b9), \
            P(a.ba), P(a.bb), P(a.bc), P(a.bd), P(a.be), P(a.bf)                                  \
    }
     ...
     const size_t ct_len, const uint8_t key[smac_KEYBYTES], const uint8_t nonce[smac_NONCEBYTES])
{
    ...
    state.a1.b0 = AES_BLOCK_XOR1(state.a1.b0, state.a1.bc);
    state.a1.b0 = AES_BLOCK_XOR1(state.a1.b0, state.a1.bd);
    state.a1.b0 = AES_BLOCK_XOR1(state.a1.b0, state.a1.be);
    state.a1.b0 = AES_BLOCK_XOR1(state.a1.b0, state.a1.bf);
